...
CREATE TABLE IF NOT EXISTS usuario(
  ...
  buscaOpcion1          VARCHAR(50) NULL,
  buscaOpcion2          VARCHAR(50) NULL,
  buscaOpcion3          VARCHAR(50) NULL,
  numeroSeguroSocial    VARCHAR(11),
  motivoRegistro        VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS vacante(
  ...
  contactoDirecto          VARCHAR(50) NOT NULL,
  emailContactoDirecto     VARCHAR(50) NOT NULL,
